...
| Deployment | Vercel (frontend) + Railway currently / Northflank prepared (backend) | Keeps the public frontend stable while preparing an always-on backend migration |
